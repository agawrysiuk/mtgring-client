...
//        }
    ...
    public void lookUpDeck() {
        ...
        javafx.scene.layout.StackPane stackPane = new StackPane();
    ...
    private void printingCard(javafx.scene.layout.StackPane stackPane, Card activeCard, int marginStackPane, int rowCards) {
