...
//                .getSubimage(0,0,480,480), Scalr.Method.ULTRA_QUALITY, Scalr.Mode.FIT_TO_WIDTH, 250, 0, Scalr.OP_ANTIALIAS);
        ...
        textOnImg.setFont(javafx.scene.text.Font.font(Font.getDefault().getName(), FontWeight.BOLD, 90*StartWindowController.X_WINDOW));
        ...
        textDescription.setFont(javafx.scene.text.Font.font(Font.getDefault().getName(), FontWeight.BOLD, 30*StartWindowController.X_WINDOW));
